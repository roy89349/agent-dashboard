...
export function CommandPalette({
  ...
  const items: Item[] = useMemo(() => {
    ...
    return [
      ...
      { group: "Navigation", label: "Conversations", hint: "team · tasks · decisions · logs · summaries", icon: MessagesSquare, run: go("/conversations") },
      { group: "Navigation", label: "Team Chat (raw)", icon: MessagesSquare, run: go("/chats") },
