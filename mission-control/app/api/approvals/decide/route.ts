...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (b.action === "pause") {
      ...
      if (pre?.status === "pending") { handlePlanRejection(decided, "dashboard"); handleWorkflowRejection(decided, "dashboard"); handleDecompositionRejection(decided, "dashboard"); } // a paused plan/step/decomposition → block + feedback
